...
@section('title', 'Lifetime Scholarship Application')

@section('content_header')
    <h1>Lifetime Scholarship Application</h1>
@endsection
...
@section('content')
        ...
        <div class="form-section">
            ...
            <div class="p-3">
                ...
                <div class="alert alert-info d-flex align-items-center mb-3" role="alert">
                    ...
                    <div>
                        <strong>Lifetime Scholarship — Processing Fee: ₹1,250</strong><br>
                        <small class="text-muted">One-time, non-refundable. Payment is required after form submission for your application to be processed.</small>
                    </div>
                </div>
    ...
    @else
        ...
        <div class="alert alert-warning d-flex align-items-center mb-3" role="alert">
            ...
            <div>
                <strong>Processing Fee: ₹1,250</strong> &nbsp;|&nbsp; Lifetime Scholarship Form
                <br><small class="text-muted">Your application will be visible to admin only after successful payment.</small>
            </div>
        </div>

        <form id="formSection" action="{{ route('public.application.lifetime.store') }}" method="POST"
            enctype="multipart/form-data">
            @csrf

            {{-- Hidden form type --}}
            <input type="hidden" name="form_type" value="lifetime">
